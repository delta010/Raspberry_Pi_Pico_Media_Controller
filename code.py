...
button_knob = digitalio.DigitalInOut(board.GP5)
...
while(1):
    if (button_gp0.value == 0):
        ...
        keyb.press(Keycode.ALT, Keycode.LEFT_CONTROL, Keycode.G)
        keyb.release_all()
        time.sleep(0.2)
    ...
    if (button_gp1.value == 0):
        ...
        keyb.press(Keycode.ALT, Keycode.LEFT_CONTROL, Keycode.U)
        keyb.release_all()
        time.sleep(0.2)
